...
class HeroRepo() : CoreRepo() {
    val heroes: List<Hero> = listOf(
        ...
        Hero("Balmond", 2, listOf(GUARDIAN, ABYSS), TANK),
        Hero("Selena", 3, listOf(SHIFTER, ELF, ASSASSIN), MAGICAL),
        Hero("Yu Zhong", 5, listOf(SHIFTER, DRAGON), PHYSICAL),
        Hero("Zhask", 4, listOf(SHIFTER, CELESTIAL), MAGICAL),
        Hero("Khufra", 2, listOf(WRESTLER, DESERT), TANK),
